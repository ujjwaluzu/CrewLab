  ...
  return (
    <section className="ways" id="explore">
      <article className="way w1">
        ...
        <Link className="go" href="/waitlist" aria-label="Share your idea"><Icon name="arrow" /></Link>
      </article>
      <article className="way w2">
        ...
        <Link className="go" href="/waitlist" aria-label="Explore projects"><Icon name="arrow" /></Link>
      </article>
